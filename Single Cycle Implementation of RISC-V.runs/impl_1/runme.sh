...
HD_PWD='D:/Auc_Crs/Sprng24/Arch_lab/Single Cycle Implementation of RISC-V/Single Cycle Implementation of RISC-V.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_2_x_1_MUX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source n_bit_2_x_1_MUX.tcl -notrace
