...
HD_PWD='D:/Auc_Crs/Sprng24/Arch_lab/Single Cycle Implementation of RISC-V/Single Cycle Implementation of RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log n_bit_2_x_1_MUX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source n_bit_2_x_1_MUX.tcl
