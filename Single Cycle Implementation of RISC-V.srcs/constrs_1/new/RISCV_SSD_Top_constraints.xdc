...
#Buttons
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { clk_push_button }]; #IO_L9P_T1_DQS_14 Sch=btnc
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets clk_push_button]
